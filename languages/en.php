 ...
 */
	...
	'widgets:add' => 'Add inquiry components',
	'widgets:add:description' => "Click on any inquiry component button below to add it to the page.",
	'widgets:position:fixed' => '(Fixed position on page)',
	'widget:unavailable' => 'You have already added this inquiry component',
	'widget:numbertodisplay' => 'Number of items to display',

	'widget:delete' => 'Remove %s',
	'widget:edit' => 'Customize this inquiry component',

	'widgets' => "Inquiry components",
	'widget' => "Inquiry component",
	'item:object:widget' => "Inquiry components",
	'widgets:save:success' => "The inquiry component was successfully saved.",
	'widgets:save:failure' => "We could not save your inquiry component.",
	'widgets:add:success' => "The inquiry component was successfully added.",
	'widgets:add:failure' => "We could not add your inquiry component.",
	'widgets:move:failure' => "We could not store the new inquiry component position.",
	'widgets:remove:failure' => "Unable to remove this inquiry component",
 ...
 */
	...
	'river:ingroup' => 'in the inquiry %s',
