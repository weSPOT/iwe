...
function execute_method($method) {
	...
	if ($result === NULL) {
		...
		//throw new APIException($msg); // No exception thrown to avoid huge log files with this "error".
		// Returns exactly the same result as the previous line, but without logging the error.
		return ErrorResult::getInstance($msg);
	}
