...
// $groups = elgg_list_entities_from_metadata(array(
// 	'type' => 'group',
// 	'limit' => 10,
// 	'full_view' => true,
// 	'pagination' => false,
...
//my groups
$user_groups = elgg_view_entity_list(get_users_membership(elgg_get_logged_in_user_guid()), array('full_view' => false));
if(!$user_groups)
	$user_groups = "You are not a member of any inquiries.";
