...
if ($revision) {
	...
	$annotation = $page->getAnnotations('hypothesis', 1, 0, 'desc');
	if ($annotation) {
		$annotation = $annotation[0];
	}
}

$page_icon = elgg_view('hypothesis/icon', array('annotation' => $annotation, 'size' => 'small'));
...
$editor_text = elgg_echo('hypothesis:strapline', array($date, $editor_link));
