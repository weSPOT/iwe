...
if ($revision) {
	...
	$annotation = $page->getAnnotations('reflection', 1, 0, 'desc');
	if ($annotation) {
		$annotation = $annotation[0];
	}
}

$page_icon = elgg_view('reflection/icon', array('annotation' => $annotation, 'size' => 'small'));
...
$editor_text = elgg_echo('reflection:strapline', array($date, $editor_link));
