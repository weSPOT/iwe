...
$variables = elgg_get_config('help');
$input = array();
...
if ($page->save()) {
	...
	elgg_clear_sticky_form('help');

	// Now save description as an annotation
	$page->annotate('help', $page->description, $page->access_id);

	system_message(elgg_echo('pages:saved'));

	if ($new_page) {
		add_to_river('river/object/help/create', 'create', elgg_get_logged_in_user_guid(), $page->guid);
	}
