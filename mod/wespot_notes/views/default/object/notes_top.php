...
if ($revision) {
	...
	$annotation = $page->getAnnotations('notes', 1, 0, 'desc');
	if ($annotation) {
		$annotation = $annotation[0];
	}
}

$page_icon = elgg_view('notes/icon', array('annotation' => $annotation, 'size' => 'small'));
...
$editor_text = elgg_echo('notes:strapline', array($date, $editor_link));
