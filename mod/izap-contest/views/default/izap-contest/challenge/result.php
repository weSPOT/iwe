...
<div class="contentWrapper">
  ...
  <?php if ($result->is_completed == 'no') { ?>
    <br/><b class="un_completed"><em><?php echo elgg_echo('izap-contest:challenge:not_completed'); ?></em></b>
  <?php } ?>

  <p><a href="<?php echo izapbase::setHref(array('context' => GLOBAL_IZAP_CONTEST_CHALLENGE_PAGEHANDLER, 'action' => 'result', 'page_owner' => FALSE, 'vars' => array($result->container_guid, elgg_get_friendly_title($result->title)))) ?>" class="cancel_button">
