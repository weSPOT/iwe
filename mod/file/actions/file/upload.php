...
if(get_input('recommended_tags')) {
	$file->recommended_tags = get_input('recommended_tags');
}

if(get_input('tag_recommender_algorithm')) {
	$file->tag_recommender_algorithm = get_input('tag_recommender_algorithm');
}
...
if ($new_file) {
	...
	if (elgg_instanceof($container, 'group')) {
		forward("file/group/$container->guid/all?phase=" . $phase . '&activity_id=' . $activity_id);
	} else {
