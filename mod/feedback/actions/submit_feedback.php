...
$message = "Page: ".$feedback->page."\rMood: ".$feedback->mood."\rAbout: ".$feedback->about."\rMessage: ".$feedback->txt;
...
if ( count($user_guids) > 0 ) {
    notify_user($user_guids, $CONFIG->site->guid, sprintf(elgg_echo('feedback:email:subject'), $feedback_sender), sprintf(elgg_echo('feedback:email:body'), $message));
}
