...
%s",
		...
		'group_tools:group:invite:csv:description' => "You can upload a CSV file with users to invite.<br />The format must be: username;e-mail address. There shouldn't be a header line.",
		...
		// Duplicate group
		'group_tools:duplicate:title' => "Duplicate this group",
		'group_tools:duplicate:label' => "Create a copy of this group and its contents (any collected data will not be duplicated).",
		'group_tools:duplicate:name' => "Name of the new group (optional):",
		'group_tools:duplicate:submit' => "Duplicate",
		'group_tools:duplicate:confirm' => "Are you sure you wish to duplicate this group?",
		'group_tools:duplicate:notduplicated' => "Error: group not duplicated",
		'group_tools:duplicate:duplicated' => "Group and group contents duplicated",
		
		// Methodology guides
		'group_tools:methodology_guides' => "Methodology guides",
