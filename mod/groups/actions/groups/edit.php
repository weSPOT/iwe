...
if($_POST['phases']) { //configuration interface was enabled so it was a new inquiry
	$group->phases = $_POST['phases'];
	$activities = preg_replace('/\s+/', ' ', $_POST['activities']); # removes multiple whitespace
	create_or_remove_widgets($group, $activities);
}
