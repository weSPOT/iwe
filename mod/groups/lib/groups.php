...
//	elgg_push_breadcrumb(elgg_echo('groups'));
	...
	$sidebar = elgg_view('groups/sidebar/language');
...
function groups_handle_owned_page() {
	...
	$content .= elgg_list_entities_from_relationship(array('relationship'=> 'operator', 'relationship_guid'=> elgg_get_page_owner_guid(), 'inverse_relationship'=> false, 'type'=> 'group', 'full_view' => false));
