...
*/
	if (elgg_in_context('groups')) {
		...
		if (elgg_in_context('group_profile')) {	
			...
			// Add Help sidebar link
			$help = elgg_get_entities_from_metadata(array(
				'type' => 'object',
				'subtype' => 'help_top',
				'metadata_name_value_pairs' => array('tags' => elgg_echo('help')),
			));
			if($help) {
			    $url = $help[0]->getURL(); 
				...
				'type' => 'object',
				'subtype' => 'help_top',
				'metadata_name_value_pairs' => array('tags' => 'Help'),
				));
				if($help)
					$url = $help[0]->getURL(); 
			}
			elgg_register_menu_item('page', array(
				'name' => 'groups-help',
				'text' => elgg_echo('group').' ' .lcfirst(elgg_echo('help')),
				'href' => $url,
				'target' => "_blank",
			));
			...
			elgg_register_menu_item('page', array(
				'name' => 'groups-quizzes',
				'text' => elgg_echo('izap-contest:contests'),
				'href' => $url,
				'target' => "_blank",
			));
		...
		// Add the rest of the sidebar links
		elgg_register_menu_item('page', array(
			'name' => 'groups:all',
