...
if ($revision) {
	...
	$annotation = $page->getAnnotations('conclusions', 1, 0, 'desc');
	if ($annotation) {
		$annotation = $annotation[0];
	}
}

$page_icon = elgg_view('conclusions/icon', array('annotation' => $annotation, 'size' => 'small'));
...
$editor_text = elgg_echo('conclusions:strapline', array($date, $editor_link));
