...
class WSOAuth2Client
{
    ...
    public function authenticate( $code )
	{
		...
		$response = $this->request( $this->token_url, $params, "GET" );
...
*/
	...
	*/
	...
	{
		Hybrid_Logger::info( "Enter WeSPOTOAuth2Client::request( $url )" );
		Hybrid_Logger::debug( "WeSPOTOAuth2Client::request(). dump request params: ", serialize( $params ) );
		...
		Hybrid_Logger::debug( "WeSPOTOAuth2Client::request(). dump request info: ", serialize( $info ) );
		Hybrid_Logger::debug( "WeSPOTOAuth2Client::request(). dump request result: ", serialize( $result ) );
