...
/**
 * To implement an OAuth 2 based service provider, Hybrid_Provider_Model_weSPOT
 * can be used to save the hassle of the authentication flow. 
 * 
 * Each class that inherit from Hybrid_Provider_Model_weSPOT have to implemenent
 * at least 2 methods:
 ...
 *
 * Hybrid_Provider_Model_weSPOT use OAuth2Client v0.1 which can be found on
 * Hybrid/thirdparty/weSPOT/OAuth2Client.php
 */
class Hybrid_Provider_Model_weSPOT extends Hybrid_Provider_Model
{
	// default permissions 
	public $scope = "";
	...
	*/
	function initialize() 
	{
		...
		require_once Hybrid_Auth::$config["path_libraries"] . "weSPOT/WSOAuth2Client.php";

		// create a new OAuth2 client instance
		$this->api = new WSOAuth2Client( $this->config["keys"]["id"], $this->config["keys"]["secret"], $this->endpoint );
