...
//	echo "<div style='padding:10px;padding-top:0px;margin-top:0px;'><div style='padding:10px;padding-left:0px;'><b>Log in with:</b></div>";
	echo "<div style='padding:10px;padding-top:0px;margin-top:0px;'>";
	...
	foreach( $HA_SOCIAL_LOGIN_PROVIDERS_CONFIG AS $item ){
		...
		if( get_plugin_setting( 'ha_settings_' . $provider_id . '_enabled', 'elgg_social_login' ) ){
			...
			<a href="javascript:void(0);" title="Connect with <?php echo $provider_name ?>" class="ha_connect_with_provider" provider="<?php echo $provider_id ?>">
				<img alt="<?php echo $provider_name ?>" title="<?php echo $provider_name ?>" src="<?php echo $assets_base_url . "large/" . strtolower( $provider_id ) . '.png' ?>" />
			</a><br/>
			<?php
		} 
	} 
