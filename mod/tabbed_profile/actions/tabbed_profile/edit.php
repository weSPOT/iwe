...
// get the widgets of this profile
$widgets = elgg_get_entities_from_relationship(array(
	'relationship' => "widget_of_profile_tab",
	'relationship_guid' => $profile_guid,
	'inverse_relationship' => true,
	'limit' => false,
));
if ($widgets) {
	foreach ($widgets as $widget) {
		if ($widget->column > $widget_layout)
			// move the widget to the last column
			$widget->move($widget_layout, 0);
	}
}
