...
echo elgg_view('css/elements/browser_choice', $vars);
echo elgg_view('css/elements/custom_index', $vars);

echo elgg_view('css/elements/elastic_main', $vars);
echo elgg_view('css/elements/search', $vars);
echo elgg_view('profile/css', $vars);;
echo elgg_view('css/elements/el_tidy_pics', $vars);
