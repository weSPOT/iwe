...
$language = array (
  ...
  'bookmarks:owner' => 'Οι σύνδεσμοι του χρήστη %s',
  ...
  'bookmarks:morebookmarks' => 'Περισσότεροι σύνδεσμοι',
  'bookmarks:more' => 'Περισσότεροι σύνδεσμοι',
  ...
  'bookmarks:notification' => '%s πρόσθεσε ένα νέο σύνδεσμο:
...
Δείτε και σχολιάστε το νέο σύνδεσμο:
...
%s',
  ...
  'bookmarks:no_title' => 'Χωρίς τίτλο',
  'bookmarks:widget:description' => 'Προβολή των πιο πρόσφατων συνδέσμων σας.',
  'bookmarks:bookmarklet:description' => 'Το εργαλείο bookmarklet σας επιτρέπει να μοιραστείτε οποιαδήποτε πηγή από το διαδίκτυο με τους φίλους σας, ή απλά να το κρατήσετε για τον εαυτό σας. Για να το χρησιμοποιήσετε, απλά σύρετε το παρακάτω κουμπί στη μπάρα διευθύνσεων του προγράμματος περιήγησής σας:',
