...
//	$form .= elgg_view('input/text', array('name' => 'confirmation', 'value' => $_SESSION['selfdelete']['confirmation'])) . "<br><br>";
	$form .= "<p><label>" . elgg_echo('member_selfdelete:label:confirmation') . "</p>";	
	$form .= elgg_view('input/submit', array('value' => elgg_echo('member_selfdelete:submit')));
	$form .= '<a class="elgg-button elgg-button-cancel" href="'. elgg_get_site_url() .'profile/">' . elgg_echo('member_selfdelete:cancel') . '</a>';
