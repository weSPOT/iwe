...
$english = array(
  ...
  'member_selfdelete:label:confirmation' => "Please confirm that you want to delete your account. This cannot be undone!",
  ...
  'member_selfdelete:submit' => "Confirm",
  'member_selfdelete:cancel' => "Cancel",
