...
$advanced = "<div id='widget-manager-widget-edit-advanced-" . $widget->getGUID() . "'>";

#$advanced .= "<h3>" . elgg_echo("widget_manager:widgets:edit:advanced") . "</h3>";
$advanced .= "<fieldset>";

$advanced .= "<div>" . elgg_echo('widget_manager:widgets:edit:custom_title') . ": " . elgg_view('input/text', array('name' => 'params[widget_manager_custom_title]', 'value' => $widget->getTitle())) . "</div>";
...
$advanced .= "<div>" . elgg_view('input/hidden', array('name' => 'params[phase]', 'value' => $phase)) . "</div>";
$advanced .= "<div>" . elgg_view('input/hidden', array('name' => 'params[activity_id]', 'value' => $widget->activity_id)) . "</div>";
#$advanced .= "<div>" . elgg_view('input/text', array('name' => 'params[order]', 'value' => $widget->order)) . "</div>";
